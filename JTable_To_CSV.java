...
public class JTable_To_CSV extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        JButton btnNewButton = new JButton("Print to CSV");
        ...
        btnNewButton_1 = new JButton("Refresh Table from CSV");
        btnNewButton_1.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		readCSV(jTable1.getModel());
        	}
        });
        				...
        				.addGroup(layout.createSequentialGroup()
        					...
        					.addGroup(layout.createParallelGroup(Alignment.TRAILING)
        						...
        						.addGroup(layout.createParallelGroup(Alignment.LEADING, false)
        							...
        							.addComponent(btnUpdateRow, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 151, Short.MAX_VALUE)))
        					.addGap(18))
         ...
         try {
            ...
            br = new BufferedReader(new FileReader(filepath));
             while ((line = br.readLine()) != null) {
               ...
               model.setValueAt(jTextFieldFN.getText(), row, 1);
               model.setValueAt(jTextFieldLN.getText(), row, 2);
               model.setValueAt(jTextFieldAGE.getText(), row, 3);
               row++;
                }
