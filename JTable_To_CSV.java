...
public class JTable_To_CSV extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnNewButton_1.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		 tableModel =(DefaultTableModel) readCSV((DefaultTableModel) jTable1.getModel());
        	}
        });
        ...
        */
        ...
        btnNewButton_5.addActionListener(new ActionListener() {
          ...
          for (Map.Entry<Integer,String> entry : map.entrySet()) {
              ...
              tableModel.addRow(new Object[]{jTextFieldID.getText(),jTextFieldFN.getText(),jTextFieldLN.getText(),jTextFieldAGE.getText()});
        	}
           }
        });   
            		...
            		for(String s:numdata) {
                     ...
                     for(int i =0; i<s.length;i++) {
                   	  String [] y = s[i].split(",");
                   	   ...
                   	   if(y[0].contains(text)||y[1].contains(text)||y[2].contains(text)||y[3].contains(text)) {
    ...
    protected void addRow() {
		// increase the size of the model and then add a row to it
    	 DefaultTableModel model = (DefaultTableModel)jTable1.getModel();
    	  model.addRow(new Object[]{jTextFieldID.getText(),jTextFieldFN.getText(),jTextFieldLN.getText(),jTextFieldAGE.getText()});
          }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(JTable_To_CSV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    void printCSV(TableModel tableModel) throws Exception{
    	StringBuilder stB = new StringBuilder();
    ...
    TableModel readCSV(DefaultTableModel model) {
    	//remove all elements
    ...
    String filepath = System.getProperty("user.home") + "\\" + "Desktop\\MyCSV.csv";
